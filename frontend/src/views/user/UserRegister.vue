  ...
  <div class="w-screen h-screen flex items-center justify-center">
    <el-card>
      ...
      <el-form class="mt-4">
        ...
        <el-form-item>
          <label>手机号</label>
          <el-input id="telephone" type="text" v-model="telephone"/>
        </el-form-item>
        <el-form-item>
          <label>邮箱</label>
...
const registerDisabled=computed(() => {
  return !(hasUsernameInput.value&&hasPasswordInput.value&&hasNameInput.value&&telLegal.value&&emailLegal.value)
})
